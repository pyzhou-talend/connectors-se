...
public class TacoKitRecordToTableRowConverterTest {
    ...
    public void testNullDatetime() {
        ...
        Schema.Entry arrayEntry = rbf
                .newEntryBuilder()
                .withName("aDateTimeArray")
                .withType(Schema.Type.ARRAY)
                .withNullable(true)
                .withElementSchema(rbf.newSchemaBuilder(Schema.Type.DATETIME).build())
                .build();
        Schema schema = rbf
        ...
        I18nMessage i18n = new InternationalizationServiceFactory(() -> Locale.US)
                .create(I18nMessage.class,
        ...
        Assertions
                .assertEquals(3, ((Collection) map.get("aDateTimeArray")).size(), "DateTimeArray must have 3 elements");
