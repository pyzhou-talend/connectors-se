...
public class PaginationStrategyFactory {
    ...
    public static PaginationStrategy getPaginationStrategy(QueryConfiguration queryConfiguration) {

        if (queryConfiguration.getOffsetLimitPagination() != null) {
            return new OffsetLimitPaginationStrategy(queryConfiguration);
        }
