...
public enum RedshiftSortStrategy {
    ...
    SINGLE,
    /**
     * Specifies that the data is sorted using a compound key made up of all of the listed columns, in the order they
     * are listed.
    ...
    /**
     * <p>
     * Specifies that the data is sorted using an interleaved sort key. A maximum of eight columns can be specified for
     * an
     * interleaved sort key.
     * An interleaved sort gives equal weight to each column, or subset of columns, in the sort key, so queries do not
     * depend on
     * the order of the columns in the sort key. When a query uses one or more secondary sort columns, interleaved
     * sorting
     ...
     * <p>
     * <b>Important</b>
     * Don’t use an interleaved sort key on columns with monotonically increasing attributes, such as identity columns,
     * dates, or
     * timestamps.
     * </p>
     */
