...
@Tag("IT")
public class MSSQLContainerTest extends JDBCBaseContainerTest {
    ...
    public class MSSQLInput extends InputTest {
    }

    public class MSSQLOutput extends OutputTest {
    }

    public class MSSQLUI extends UIActionServiceTest {
    }
