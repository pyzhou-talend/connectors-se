...
public class AvroIterator implements Iterator<Record>, Serializable {
    ...
    private final AvroToRecord converter;
    ...
    public static class Builder {
        ...
        public AvroIterator.Builder
                withConfiguration(@Configuration("avroConfiguration") final AvroFormatOptions configuration) {
            this.configuration = configuration;
            converter = new AvroToRecord(factory);
