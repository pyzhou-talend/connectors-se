...
public final class OAuth2Utils {
    ...
    static String getAccessToken(JDBCDataStore connection, TokenClient tokentClient, I18nMessage i18n) {
    ...
    private static String getPayload(JDBCDataStore connection) {
    ...
    private static String getAuthorization(JDBCDataStore connection) {
